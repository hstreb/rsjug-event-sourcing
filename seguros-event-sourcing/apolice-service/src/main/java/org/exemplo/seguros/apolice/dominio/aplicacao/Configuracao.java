...
import org.exemplo.seguros.apolice.dominio.dominio.evento.Evento;
...
public class Configuracao {
    ...
    @Bean
    public <T extends Evento> ProducerFactory<Long, T> producerFactory() {
        return new DefaultKafkaProducerFactory<>(producerConfigs());
    }

    @Bean
    public <T extends Evento> KafkaTemplate<Long, T> kafkaTemplate() {
